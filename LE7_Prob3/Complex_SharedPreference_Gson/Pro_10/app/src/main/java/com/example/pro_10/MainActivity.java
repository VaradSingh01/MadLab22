...
public class MainActivity extends AppCompatActivity {
    ...
    String []winnersArray={"Vansh","Ayushi","Ritika","Awasthi"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPreferences=this.getSharedPreferences("com.example.pro_10", Context.MODE_PRIVATE);
